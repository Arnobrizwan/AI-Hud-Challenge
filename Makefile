...
dev-up-fast:
	...
	@docker-compose -f docker-compose.dev.yml --profile fast up --build -d
...
# 🚀 FULL DEVELOPMENT - ALL 16 SERVICES (10-15 minutes)
dev-up: 
