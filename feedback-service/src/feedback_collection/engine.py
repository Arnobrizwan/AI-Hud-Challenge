...
class FeedbackCollectionEngine:
    ...
    async def analyze_feedback_content(self, feedback: UserFeedback) -> Dict[str, Any]:
        ...
        requires_review = sentiment_score < 0.2 or any(  # Very negative
            word in feedback.comment.lower() for word in ["inappropriate", "offensive", "wrong"]
        )
