...
async def get_model_health(model_name: str, monitoring_service: ModelMonitoringService = Depends()):
    """Get model health status"""

    try:
        health = await monitoring_service.get_model_health(model_name)

        return ModelHealthResponse(model_name=model_name, health=health)
...
async def detect_data_drift(
    ...
    try:
        ...
        drift_result = {
            ...
            "feature_drift_scores": {"feature_1": 0.12, "feature_2": 0.18, "feature_3": 0.08},
...
async def list_alerts(
    ...
    try:
        ...
        return {"alerts": paginated_alerts, "total": total, "page": page, "page_size": page_size}
