...
from ..models.schemas import (
    NotificationDecision, DeliveryResult, DeliveryChannel, NotificationType
)
    ...
    async def select_optimal_channel(
        ...
        try:
            ...
            available_performance = {
                channel: channel_performance.get(channel, 0.5)
    ...
    async def _update_channel_performance(
        ...
        try:
            ...
            if cache_key in self.channel_performance:
                ...
                self.channel_performance[cache_key][channel] = max(0.0, min(1.0, 
                    self.channel_performance[cache_key][channel] + adjustment
                ))
