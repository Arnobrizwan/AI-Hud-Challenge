...
from ..models.schemas import (
    NotificationPreferences, NotificationType, DeliveryChannel
)
from ..exceptions import PreferenceManagementError
from ..database import get_async_session, UserPreferences
        ...
        try:
            ...
            analytics = {
                ...
                'relevance_thresholds': {
                    k.value: v for k, v in prefs.relevance_thresholds.items()
                },
            ...
            async with get_async_session() as session:
                ...
                if row:
                    ...
                    return NotificationPreferences(
                        user_id=row.user_id,
                        enabled_types=[
                            NotificationType(t) for t in (row.enabled_types or [])
                        ],
                        delivery_channels=[
