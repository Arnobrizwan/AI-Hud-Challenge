...
from ..models.schemas import (
    NotificationCandidate, NotificationPreferences, UserProfile
)
...
class TrendingDetector:
    ...
    async def _load_trending_data(self) -> None:
        ...
        self.trending_keywords = {
            'breaking', 'urgent', 'important', 'latest', 'update', 'news',
            'crisis', 'emergency', 'alert', 'warning', 'developing'
        }
        ...
        self.trending_topics = {
            'politics', 'technology', 'health', 'economy', 'climate',
...
class RelevanceScorer:
    ...
    async def score_relevance(
        ...
        try:
            ...
            # Trending factor
            trending_score = await self.trending_detector.get_trending_score(
                candidate.content
            )
