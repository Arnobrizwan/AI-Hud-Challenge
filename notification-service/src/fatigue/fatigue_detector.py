...
class FatigueDetector:
    ...
    async def check_fatigue(
        ...
        try:
            ...
            is_fatigued = (
                hourly_count >= hourly_threshold or
                daily_count >= daily_threshold or
                fatigue_score >= 0.8
            )
    ...
    async def record_notification_sent(
        ...
        try:
            ...
            logger.error(
                "Error recording notification sent",
                user_id=user_id,
                error=str(e),
                exc_info=True
            )
    ...
    async def _generate_fatigue_recommendations(
        self, 
        user_id: str, 
        analytics: Dict
    ) -> list:
