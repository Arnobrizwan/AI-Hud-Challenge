...
from ..models.schemas import (
    NewsItem, NotificationCandidate, NotificationType, Priority
)
...
class BreakingNewsHandler:
    ...
    async def _verify_breaking_news(self, news_item: NewsItem) -> bool:
        ...
        try:
            ...
            keyword_matches = sum(
                1 for keyword in self.breaking_news_criteria['keyword_boost']
    ...
    async def _get_breaking_news_eligible_users(self, news_item: NewsItem) -> List[str]:
        ...
        try:
            ...
            if len(eligible_users) > max_breaking_news_users:
                ...
                eligible_users = await self._prioritize_users(eligible_users, max_breaking_news_users)
    ...
    async def update_breaking_news_criteria(
        ...
        try:
            ...
            logger.info(
                "Updated breaking news criteria",
                criteria=criteria
            )
