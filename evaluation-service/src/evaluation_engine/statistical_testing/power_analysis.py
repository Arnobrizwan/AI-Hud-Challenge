...
class PowerAnalyzer:
    ...
    async def calculate_sample_size(self, 
                                  ...
                                  baseline_conversion_rate: float = 0.5) -> int:
    ...
    async def _chi_square_power(self, 
                               effect_size: float, 
                               alpha: float, 
                               power: float,
                               baseline_rate: float) -> int:
    ...
    def _generate_power_recommendations(self, 
                                      power: float, 
                                      sample_size: int, 
                                      required_n: int) -> List[str]:
