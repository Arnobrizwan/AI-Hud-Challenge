...
from scipy.stats import ttest_ind, ttest_rel, mannwhitneyu, wilcoxon, chi2_contingency
import math
...
class StatisticalTester:
    ...
    async def two_sample_test(self, 
                            data1: List[float], 
                            data2: List[float],
    ...
    async def _t_test(self, data1: np.ndarray, data2: np.ndarray, alternative: str) -> Dict[str, Any]:
        """Independent t-test"""
    ...
    async def _welch_t_test(self, data1: np.ndarray, data2: np.ndarray, alternative: str) -> Dict[str, Any]:
    ...
    async def multiple_comparison_correction(self, 
                                          p_values: List[float], 
