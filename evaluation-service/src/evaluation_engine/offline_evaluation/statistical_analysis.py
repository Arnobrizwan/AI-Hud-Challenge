...
class StatisticalAnalyzer:
    ...
    async def bootstrap_confidence_interval(
        self, metric_value: float, bootstrap_samples: int = 1000, confidence_level: float = 0.95
    ) -> Dict[str, float]:
    ...
    async def calculate_confidence_interval(
        self, data: np.ndarray, confidence_level: float = 0.95, method: str = "t_distribution"
    ) -> Dict[str, float]:
