...
def create_app() -> FastAPI:
    ...
    app.include_router(offline_evaluation_router, prefix="/api/v1/offline-evaluation", tags=["offline-evaluation"])

    app.include_router(online_evaluation_router, prefix="/api/v1/online-evaluation", tags=["online-evaluation"])

    app.include_router(business_impact_router, prefix="/api/v1/business-impact", tags=["business-impact"])

    app.include_router(drift_detection_router, prefix="/api/v1/drift-detection", tags=["drift-detection"])
