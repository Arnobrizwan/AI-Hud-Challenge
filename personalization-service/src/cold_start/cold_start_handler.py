...
from ..models.schemas import UserProfile, ContentItem, Recommendation, UserContext
...
class ColdStartHandler:
    ...
    async def handle_user_cold_start(self, user_id: str, 
                                   context: Optional[UserContext] = None) -> List[Recommendation]:
    ...
    async def _get_demographic_recommendations(self, user_id: str, 
                                             context: Optional[UserContext]) -> List[Recommendation]:
    ...
    async def _combine_cold_start_strategies(self, demographic_recs: List[Recommendation],
                                           popularity_recs: List[Recommendation],
                                           onboarding_recs: List[Recommendation]) -> List[Recommendation]:
    ...
    async def _get_demographic_template(self, user_id: str, 
                                      context: Optional[UserContext]) -> Dict[str, Any]:
    ...
    async def _compute_demographic_score(self, content_row: Dict[str, Any], 
