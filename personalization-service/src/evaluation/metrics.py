...
class PersonalizationMetrics:
    ...
    async def calculate_online_metrics(
        self, user_id: str, time_window: int = 7
    ) -> Dict[str, float]:
    ...
    async def calculate_business_metrics(
        ...
        return {
            ...
            "avg_interactions_per_user": (
                total_interactions / unique_users if unique_users > 0 else 0
            ),
    ...
    def _calculate_coverage(
        self, recommendations: List[Recommendation], ground_truth: List[str]
    ) -> float:
    ...
    def _calculate_accuracy(
        self, predictions: List[Dict[str, Any]], actual_outcomes: List[Dict[str, Any]]
    ) -> float:
