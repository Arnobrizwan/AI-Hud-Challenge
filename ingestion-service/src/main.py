...
from src.models.api import (
    APIResponse, HealthCheckResponse, IngestionRequest, IngestionResponse,
    SourceListResponse, SourceStatsResponse, ContentSearchRequest,
    ContentSearchResponse, DuplicateDetectionRequest, DuplicateDetectionResponse,
    MetricsResponse, BatchStatusResponse, SourceConfigRequest, ErrorResponse
)
from src.models.content import ProcessingStatus, SourceType, ContentType
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        await pubsub_service.create_subscription(
            settings.PUBSUB_TOPIC_INGESTION,
            settings.PUBSUB_SUBSCRIPTION_INGESTION
        )
