...
from src.models.feeds import ParsedFeed, FeedParseResult, FeedType
...
class RSSAdapter(BaseAdapter):
    ...
    async def _process_feed_item(self, item: Dict[str, Any], feed_metadata: Dict[str, Any]) -> Optional[NormalizedArticle]:
