...
@pytest.mark.asyncio
async def test_rank_content_endpoint(client, sample_ranking_request) -> Dict[str, Any]:
...
@pytest.mark.asyncio
async def test_background_task_logging(client, sample_ranking_request) -> Dict[str, Any]:
