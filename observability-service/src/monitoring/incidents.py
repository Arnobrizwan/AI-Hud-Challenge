...
class IncidentManager:
    ...
    async def create_emergency_incident(self, incident_type: str, severity: str, 
    ...
    def _find_incident_template(self, incident: Incident) -> Optional[IncidentTemplate]:
        ...
        for template in self.templates.values():
            if (template.incident_type == incident.incident_type and 
    ...
    async def update_post_mortem(self, post_mortem_id: str, updates: Dict[str, Any], 
                               user: str) -> PostMortem:
