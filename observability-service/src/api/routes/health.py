...
async def get_service_health(service_name: str):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get health for service {service_name}: {str(e)}"
        )
...
async def get_infrastructure_health():
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get infrastructure health: {str(e)}"
        )
...
async def trigger_service_health_check(service_name: str):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to trigger health check for {service_name}: {str(e)}"
        )
...
async def get_health_metrics_summary():
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get health metrics summary: {str(e)}"
        )
