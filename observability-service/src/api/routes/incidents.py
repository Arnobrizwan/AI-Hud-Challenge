...
async def update_incident(incident_id: str, update_request: IncidentUpdateRequest, user: str = Body(..., embed=True)):
    """Update incident"""
...
async def create_post_mortem(incident_id: str, post_mortem_request: PostMortemRequest) -> Dict[str, Any]:
