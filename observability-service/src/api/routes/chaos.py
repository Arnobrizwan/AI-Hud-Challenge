...
async def get_chaos_experiment(experiment_id: str):
    ...
    try:
        ...
        if not experiment:
            raise HTTPException(
                status_code=404, detail=f"Chaos experiment {experiment_id} not found"
            )
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get chaos experiment {experiment_id}: {str(e)}"
        )
...
async def execute_chaos_experiment(experiment_id: str):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to execute chaos experiment {experiment_id}: {str(e)}"
        )


@router.get(
    "/experiments/{experiment_id}/executions", response_model=List[ExperimentExecutionResponse]
)
...
async def get_experiment_execution(execution_id: str):
    ...
    try:
        ...
        if not execution:
            raise HTTPException(
                status_code=404, detail=f"Experiment execution {execution_id} not found"
            )
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get experiment execution {execution_id}: {str(e)}"
        )
...
async def get_chaos_experiment_templates():
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get chaos experiment templates: {str(e)}"
        )
...
async def enable_chaos_experiment(experiment_id: str):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to enable chaos experiment {experiment_id}: {str(e)}"
        )
...
async def disable_chaos_experiment(experiment_id: str):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to disable chaos experiment {experiment_id}: {str(e)}"
        )
