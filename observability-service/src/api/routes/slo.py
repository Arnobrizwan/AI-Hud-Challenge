...
async def get_slo_status_by_id(slo_id: str, time_window: int = Query(3600, description="Time window in seconds")):
...
async def get_error_budget_by_slo(slo_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "time_to_exhaustion": (
                error_budget.time_to_exhaustion.isoformat() if error_budget.time_to_exhaustion else None
            ),
...
async def get_sli_status(sli_id: str, time_window: int = Query(3600, description="Time window in seconds")):
...
@router.get("/trends")
async def get_slo_trends(time_window: int = Query(86400, description="Time window in seconds (default: 24 hours)")):
