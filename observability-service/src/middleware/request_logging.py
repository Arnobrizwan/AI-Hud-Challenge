...
class RequestLoggingMiddleware:
    ...
    async def _log_response(self, request: Request, status_code: int, 
                          duration: float, response_data: Dict[str, Any]):
        """Log response"""
...
class StructuredRequestLoggingMiddleware(RequestLoggingMiddleware):
    ...
    async def _log_request(self, request: Request):
        ...
        try:
            ...
            logger.info(
                "Request started",
                extra={"structured_data": request_data}
            )
    ...
    async def _log_response(self, request: Request, status_code: int, 
        ...
        try:
            ...
            getattr(logger, log_level)(
                "Request completed",
                extra={"structured_data": response_log_data}
            )
