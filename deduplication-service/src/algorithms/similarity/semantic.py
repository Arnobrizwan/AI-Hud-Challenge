...
class SemanticSimilarityCalculator:
    ...
    async def compute_batch_similarity(
        self, articles: List[NormalizedArticle], target_article: NormalizedArticle
    ) -> List[float]:
        ...
        similarities = cosine_similarity(target_embedding.reshape(1, -1), batch_embeddings)[0]
    ...
    async def find_similar_articles(
        ...
        # Compute similarities
        similarities = await self.compute_batch_similarity(candidate_articles, target_article)
    ...
    async def compute_topic_similarity(self, topics1: List[Topic], topics2: List[Topic]) -> float:
...
class ContentSimilarityCalculator:
    ...
    async def compute_title_similarity(self, title1: str, title2: str) -> float:
    ...
    async def compute_content_similarity(self, content1: str, content2: str) -> float:
