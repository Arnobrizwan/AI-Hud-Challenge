...
class TestIncrementalDBSCAN:
    ...
    async def test_fit_predict(self, clustering_engine, mock_articles_for_clustering):
        ...
        cluster_labels = await clustering_engine.fit_predict(
            mock_articles_for_clustering, features
        )
    ...
    async def test_incremental_fit(self, clustering_engine, mock_articles_for_clustering):
        ...
        initial_labels = await clustering_engine.fit_predict(
            initial_articles, initial_features
        )
        ...
        new_labels = await clustering_engine.incremental_fit(
            new_articles, new_features
        )
...
class TestEventGroupingEngine:
    ...
    def test_get_event_quality_metrics(self, event_grouping_engine):
        ...
        from src.models.schemas import NewsEvent, Cluster
