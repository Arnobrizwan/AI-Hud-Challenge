...
class TestDeduplicationPipeline:
    ...
    @pytest.mark.asyncio
    async def test_process_article_no_duplicates(self, deduplication_pipeline, sample_article) -> Dict[str, Any]:
    ...
    @pytest.mark.asyncio
    async def test_process_batch(self, deduplication_pipeline, sample_articles) -> Dict[str, Any]:
    ...
    @pytest.mark.asyncio
    async def test_find_lsh_candidates(self, deduplication_pipeline, sample_article) -> Dict[str, Any]:
    ...
    @pytest.mark.asyncio
    async def test_filter_semantic_matches(self, deduplication_pipeline, sample_article, sample_articles):
        """Test semantic similarity filtering."""
        candidates = sample_articles[:3]  # Use first 3 articles as candidates

        matches = await deduplication_pipeline._filter_semantic_matches(sample_article, candidates, threshold=0.85)
    ...
    @pytest.mark.asyncio
    async def test_classify_duplicates(self, deduplication_pipeline, sample_article):
        ...
        duplicates = await deduplication_pipeline._classify_duplicates(sample_article, similarity_scores)
    ...
    @pytest.mark.asyncio
    async def test_update_indices(self, deduplication_pipeline, sample_article):
        """Test index updates."""
        content_fingerprint = {
...
class TestDeduplicationService:
    ...
    @pytest.mark.asyncio
    async def test_deduplicate_article(self, deduplication_service, sample_article):
    ...
    @pytest.mark.asyncio
    async def test_deduplicate_batch(self, deduplication_service, sample_articles):
    ...
    @pytest.mark.asyncio
    async def test_find_duplicates(self, deduplication_service, sample_article):
        ...
        similar_articles = await deduplication_service.find_duplicates(sample_article, threshold=0.85)
