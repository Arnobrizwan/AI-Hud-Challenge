...
class TestDeduplicationPipeline:
    ...
    @pytest.mark.asyncio
    async def test_process_article_no_duplicates(self, deduplication_pipeline, sample_article):
    ...
    @pytest.mark.asyncio
    async def test_process_batch(self, deduplication_pipeline, sample_articles):
        ...
        assert all(
            result.article_id == article.id for result, article in zip(results, sample_articles)
        )

    @pytest.mark.asyncio
    async def test_find_lsh_candidates(self, deduplication_pipeline, sample_article):
    ...
    async def test_filter_semantic_matches(
        self, deduplication_pipeline, sample_article, sample_articles
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_pipeline_stats(self, deduplication_pipeline):
...
class TestDeduplicationService:
    ...
    @pytest.mark.asyncio
    async def test_get_service_stats(self, deduplication_service):
    ...
    @pytest.mark.asyncio
    async def test_health_check(self, deduplication_service):
        """Test health check."""
