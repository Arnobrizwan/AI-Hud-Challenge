    ...
    def _select_sentences(
        ...
        try:
            ...
            for sentence, score in sentence_scores:
                ...
                if current_length + sentence_length > target_length and len(selected_sentences) >= min_sentences:
                    break
            ...
            if len(selected_sentences) < min_sentences:
                ...
                for sentence, _ in sentence_scores[len(selected_sentences):len(selected_sentences) + remaining]:
