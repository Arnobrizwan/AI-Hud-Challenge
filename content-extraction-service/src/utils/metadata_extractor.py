...
class MetadataExtractor:
    ...
    def __init__(self):
        ...
        self.og_properties = [
            ...
            'og:site_name', 'og:locale', 'og:article:author', 'og:article:published_time',
            'og:article:modified_time', 'og:article:section', 'og:article:tag'
        ]
    ...
    async def _extract_author(self, soup: BeautifulSoup, og_data: Dict[str, str], json_ld_data: Dict[str, Any]) -> Optional[str]:
        """Extract author information."""
        try:
