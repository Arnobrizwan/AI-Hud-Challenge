...
class HTMLCleaner:
    ...
    def __init__(
        ...
        self.allowed_tags = allowed_tags or [
            ...
            'strong', 'ul', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'img', 'br', 'hr', 'pre',
            'span', 'div', 'table', 'tbody', 'td', 'th', 'thead', 'tr', 'figcaption', 'figure'
        ]
    ...
    async def _remove_advertisement_elements(self, soup: BeautifulSoup) -> None:
        ...
        ad_selectors = [
            ...
            '.ads', '.advertisement', '.banner', '.sponsor', '.promo',
    ...
    async def _remove_social_widgets(self, soup: BeautifulSoup) -> None:
        ...
        social_selectors = [
            ...
            '[class*="instagram"]', '[class*="youtube"]', '[class*="pinterest"]'
        ]
    ...
    async def extract_main_content(self, html_content: str) -> str:
        ...
        try:
            ...
            main_selectors = [
                ...
                '#content', '#main', '#post', '#article', '.main-content',
    ...
    async def remove_boilerplate(self, html_content: str) -> str:
        ...
        try:
            ...
            boilerplate_selectors = [
                ...
                '[class*="cookie"]', '[class*="privacy"]', '[class*="terms"]',
                '[class*="disclaimer"]', '[class*="copyright"]'
            ]
