...
from ..models.content import ProcessedImage, VideoMetadata, ContentType
...
class HTMLProcessor:
    ...
    async def _extract_additional_content(self, soup: BeautifulSoup, base_url: str) -> Dict[str, Any]:
