...
class Settings(BaseSettings):
    ...
    CLOUD_STORAGE_BUCKET: str = Field(default="content-extraction-cache", description="Cloud Storage bucket for caching")
    ...
    ALLOWED_CONTENT_TYPES: List[str] = Field(
        default=["text/html", "application/pdf", "text/plain", "application/msword", "application/vnd.openxmlformats-officedocument.wordprocessingml.document"],
    ...
    SUPPORTED_LANGUAGES: List[str] = Field(default=["en", "es", "fr", "de", "it", "pt", "ru", "zh", "ja", "ko"], description="Supported languages")
    ...
    ALLOWED_HTML_TAGS: List[str] = Field(
        default=["p", "br", "strong", "em", "u", "h1", "h2", "h3", "h4", "h5", "h6", "ul", "ol", "li", "blockquote", "a", "img"],
