...
from ..models.content import Topic, TopicCategory, ExtractedContent
...
class TopicClassifier:
    ...
    async def _predict_with_keywords(self, text: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            topic_keywords = {
                "technology": {
                    "keywords": ["technology", "tech", "software", "hardware", "computer", "digital", "ai", "artificial intelligence"],
                    "weight": 1.0
                },
                "business": {
                    "keywords": ["business", "company", "corporate", "finance", "marketing", "management", "strategy"],
                    "weight": 1.0
                },
                "politics": {
                    "keywords": ["politics", "political", "government", "election", "policy", "democracy", "republican", "democrat"],
                    "weight": 1.0
                },
                "health": {
                    "keywords": ["health", "medical", "medicine", "healthcare", "doctor", "hospital", "disease", "treatment"],
                    "weight": 1.0
                },
                "science": {
                    "keywords": ["science", "scientific", "research", "study", "experiment", "discovery", "physics", "chemistry", "biology"],
                    "weight": 1.0
                }
            }
