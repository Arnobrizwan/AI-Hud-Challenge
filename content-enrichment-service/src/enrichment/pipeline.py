...
class ContentEnrichmentPipeline:
    ...
    async def enrich_content(
        ...
        try:
            ...
            logger.info("Starting parallel enrichment tasks", 
    ...
    async def _classify_topics(
        ...
        try:
            return await self.topic_classifier.classify_topics(
                content, 
                language=language
            )
        except Exception as e:
    ...
    async def _extract_signals(
        ...
        try:
            return await self.signal_extractor.extract_signals(
                content, 
                language=language
            )
        except Exception as e:
    ...
    async def _compute_trustworthiness(
        self, 
        content: ExtractedContent, 
        language: str
    ) -> Any:
        ...
        try:
            return await self.signal_extractor.compute_trustworthiness(
                content, 
                language=language
            )
        except Exception as e:
    ...
    async def enrich_batch(
        ...
        **kwargs
        ...
        for i in range(0, len(contents), batch_size):
            ...
            batch_tasks = [
                self.enrich_content(content, processing_mode, **kwargs)
