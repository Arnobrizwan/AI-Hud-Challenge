...
class EntityKnowledgeBase:
    ...
    async def link_entity(self, entity: 'Entity') -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error("Entity linking failed", 
        ...
        try:
            async with self.session_factory() as session:
                ...
                result = await session.execute(similarity_query, {
                    "embedding": entity_embedding[0].tolist()
                })
            ...
            async with httpx.AsyncClient(timeout=10.0) as client:
                ...
                if "search" in data and data["search"]:
                    ...
                    if best_match:
                        ...
                        detailed_info = await self._get_wikidata_details(
                            best_match["id"], client
                        )
        ...
        for result in search_results:
            ...
            if "description" in result:
                desc_similarity = self._calculate_text_similarity(
                    entity.text, result["description"]
                )
