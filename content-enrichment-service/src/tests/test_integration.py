...
from ..models.content import ExtractedContent, ContentType, ProcessingMode
...
class TestContentEnrichmentPipeline:
    ...
    async def test_enrich_content_with_mock_components(self, pipeline, sample_content):
        ...
        with patch.object(pipeline.entity_extractor, 'extract_entities') as mock_entities, \
            ...
            mock_sentiment.return_value = Mock(sentiment="positive", confidence=0.8, subjectivity=0.6, polarity=0.7, emotions={})
