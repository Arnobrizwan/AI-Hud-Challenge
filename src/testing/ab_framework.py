...
class ABTestingFramework:
    ...
    async def _initialize_experiments(self):
    ...
    async def get_variant(self, user_id: str, experiment: str) -> str:
        ...
        try:
            ...
            # Cache assignment
            await self.cache_manager.set(cache_key, variant_id, ttl=86400)  # 24 hours
            ...
            logger.error("Variant assignment failed", error=str(e), user_id=user_id, experiment=experiment)
            return "control"
    ...
    async def _log_assignment(self, user_id: str, experiment: str, variant: str):
    ...
    async def record_result(self, user_id: str, experiment: str, 
    ...
    async def update_experiment(self, experiment_id: str, 
