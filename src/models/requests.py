...
class ProcessingJobRequest(BaseModel):
    ...
    source_urls: List[HttpUrl] = Field(description="URLs to process")
...
class BulkProcessingRequest(BaseModel):
    ...
    jobs: List[ProcessingJobRequest] = Field(description="Processing jobs")
...
class AnalyticsRequest(BaseModel):
    ...
    granularity: str = Field(
        default="day", pattern="^(hour|day|week|month)$", description="Time granularity"
    )
