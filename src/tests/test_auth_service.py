...
from src.services.auth_service import AuthService, FirebaseAuthService, JWTAuthService
from src.services.auth_service import AuthenticationError, TokenExpiredError, TokenInvalidError
from src.models.auth import (
    LoginRequest, UserClaims, AuthenticatedUser, 
    AuthProvider, TokenType, TokenValidationRequest
)
...
class TestFirebaseAuthService:
    ...
    async def test_validate_token_success(self, firebase_service, mock_firebase_auth):
        ...
        mock_firebase_auth.assert_called_once_with(token, check_revoked=True, app=firebase_service.app)
...
class TestAuthService:
    ...
    def auth_service(self):
        ...
        with patch('src.services.auth_service.FirebaseAuthService'), \
    ...
    async def test_authenticate_api_key_success(self, auth_service):
        ...
        # Mock JWT validation
        auth_service.jwt_auth.verify_token = Mock(return_value={
            "uid": "api-user-123",
