...
from src.models.auth import (
    UserClaims, AuthenticatedUser, LoginRequest, LoginResponse,
    TokenValidationRequest, TokenValidationResponse, AuthProvider, TokenType
)
from src.services.circuit_breaker import get_circuit_breaker, CircuitBreakerConfig
...
class FirebaseAuthService:
    ...
    async def validate_token(self, token: str, client_ip: str = None, 
                           user_agent: str = None) -> AuthenticatedUser:
...
class AuthService:
    ...
    async def authenticate(self, request: LoginRequest, client_ip: str = None,
    ...
    async def validate_request_token(self, request: TokenValidationRequest,
                                   client_ip: str = None,
