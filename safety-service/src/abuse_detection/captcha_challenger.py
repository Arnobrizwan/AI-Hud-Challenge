...
class CaptchaChallenger:
    ...
    async def challenge_user(self, user_id: str, challenge_type: str = 'text_captcha',
        ...
        try:
            ...
            if existing_challenge and existing_challenge.can_attempt():
                return {
                    ...
                    'attempts_remaining': existing_challenge.max_attempts - existing_challenge.attempts
                }
    ...
    async def verify_challenge(self, user_id: str, challenge_id: str, 
        ...
        try:
            ...
            if is_correct:
                ...
                logger.info(f"User {user_id} failed challenge {challenge_id} (attempt {challenge.attempts})")
    ...
    async def generate_challenge_content(self, challenge_type: str, difficulty: str) -> Dict[str, Any]:
    ...
    def generate_challenge_id(self) -> str:
        ...
        return hashlib.md5(f"{secrets.token_hex(16)}{datetime.utcnow().timestamp()}".encode()).hexdigest()[:16]
