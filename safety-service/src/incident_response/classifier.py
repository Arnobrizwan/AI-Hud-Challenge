...
from safety_engine.models import SafetyIncident, IncidentClassification
...
class IncidentClassifier:
    ...
    async def calculate_classification_confidence(self, incident: SafetyIncident, 
                                                severity: str, impact_assessment: Dict[str, str]) -> float:
        ...
        try:
            ...
            if severity in self.severity_rules:
                ...
                threshold_matches = sum(1 for key, threshold in thresholds.items() 
    ...
    async def load_classification_models(self):
