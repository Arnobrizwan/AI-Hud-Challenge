...
class FeatureImportanceMonitor:
    ...
    def calculate_importance_drift(self, ref_importance: Dict[str, float],
                                 curr_importance: Dict[str, float]) -> float:
    ...
    def calculate_feature_changes(self, ref_importance: Dict[str, float],
                                curr_importance: Dict[str, float]) -> Dict[str, float]:
    ...
    def calculate_confidence(self, ref_importance: Dict[str, float],
                           curr_importance: Dict[str, float]) -> float:
        ...
        try:
            ...
            magnitude_consistency = 1.0 - abs(ref_magnitude - curr_magnitude) / max(ref_magnitude, curr_magnitude, 1e-10)
    ...
    def calculate_ranking_correlation(self, ref_ranking: List[str],
                                    curr_ranking: List[str]) -> float:
    ...
    async def get_importance_summary(self, importance: Dict[str, float],
