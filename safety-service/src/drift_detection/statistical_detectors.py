...
class BaseStatisticalDetector:
    ...
    async def test(self, reference_data: pd.Series, current_data: pd.Series) -> StatisticalTestResult:
...
class PopulationStabilityIndexDetector(BaseStatisticalDetector):
    ...
    def create_bins(self, ref_data: pd.Series, curr_data: pd.Series, n_bins: int = 10) -> np.ndarray:
