...
class PostgreSQLVectorStore:
    ...
    async def store_vector(self, content_id: str, embedding_type: str, 
        ...
        try:
            async with self.pool.acquire() as conn:
                ...
                """, content_id, embedding_type, vector, json.dumps(metadata))
        ...
        try:
            async with self.pool.acquire() as conn:
                ...
                return {
                    ...
                    'embeddings_by_type': {row['embedding_type']: row['count'] for row in type_counts},
