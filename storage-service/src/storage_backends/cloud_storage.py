...
class MediaStorageManager:
    ...
    async def store_media_files(self, article_id: str, media_files: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    async def _store_file(self, file_key: str, content: bytes, content_type: str) -> str:
        ...
        try:
            if self.settings.cloud_storage_provider == "aws":
                ...
                raise ValueError(f"Unsupported storage provider: {self.settings.cloud_storage_provider}")
