    ...
    def _deserialize_article(self, data: bytes) -> Optional[RetrievedArticle]:
        ...
        try:
            ...
            return RetrievedArticle(
                ...
                published_at=datetime.fromisoformat(article_dict['published_at']) if article_dict['published_at'] else None,
            ...
            for key in search_keys:
                try:
                    ...
                    if search_data and article_id.encode() in search_data:
                        ...
                        logger.debug(f"Invalidated search cache {key} containing article {article_id}")
                except Exception:
