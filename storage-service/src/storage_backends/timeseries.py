...
class TimeseriesDBManager:
    ...
    async def get_article_metrics(self, article_id: str, 
    ...
    async def get_daily_metrics(self, start_date: datetime, 
            ...
            async with self.pool.acquire() as conn:
                ...
                for row in rows:
                    metrics.append({
                        ...
                        'avg_reading_time': float(row['avg_reading_time']) if row['avg_reading_time'] else 0,
    ...
    async def get_hourly_metrics(self, start_time: datetime, 
                               end_time: Optional[datetime] = None) -> List[Dict[str, Any]]:
    ...
    async def get_source_performance(self, source: str, 
