...
async def store_article(
    ...
    try:
        ...
        background_tasks.add_task(storage.update_search_indexes, article.id)
        background_tasks.add_task(storage.update_cache_warmup, article.id)
...
async def handle_gdpr_request(
    ...
    try:
        ...
        background_tasks.add_task(lifecycle.log_gdpr_request, gdpr_request)
...
async def optimize_query(
    query: Dict[str, Any], optimizer: QueryOptimizer = Depends(get_query_optimizer)
):
