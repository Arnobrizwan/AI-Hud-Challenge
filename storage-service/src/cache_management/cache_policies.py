...
class CachePolicies:
    ...
    async def get_cache_config(self, content_type: ContentType, 
    ...
    async def _determine_strategy(self, content_type: ContentType, 
    ...
    async def _matches_policy(self, policy: Dict[str, Any], 
    ...
    async def _apply_context_adjustments(self, config: Dict[str, Any], 
    ...
    async def get_cache_tags(self, content_type: ContentType, 
    ...
    async def should_preload(self, content_type: ContentType, 
    ...
    async def should_warm_cache(self, content_type: ContentType, 
                              context: Dict[str, Any] = None) -> bool:
